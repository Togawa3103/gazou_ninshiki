...
index = np.where(
    (Y == "20170109142408075.jpg") | 
    (Y == "20170109150557335.jpg") | 
    (Y == "20170116174525125.jpg")
)
...
# log for TensorBoard
logging = TensorBoard(log_dir = "log_race/")
